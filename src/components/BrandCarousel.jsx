...
function BrandCarousel() {
  ...
  const brands = [
    { name: 'Elfbar', logo: './brands/elfbar.png' },
    { name: 'Flum', logo: './brands/flum.png' },
    { name: 'Geekbar', logo: './brands/geekbar.png' },
    { name: 'Meloso', logo: './brands/meloso.png' },
    { name: 'Dojo', logo: './brands/dojo.png' },
    { name: 'Smok', logo: './brands/smok.png' },
    { name: 'Juul', logo: './brands/juul.png' },
    { name: 'PuffCo', logo: './brands/puffco.png' },
  ];
